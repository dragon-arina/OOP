...
class MainActivity : AppCompatActivity() {
    ...
    private val namesList =  listOf("Семен", "Илья", "Андрей", "Федор", "Максим", "Матвей", "Данила", "Григорий", "Давид")
    
    private val patronymicList = listOf("Семенович", "Ильич", "Андреевич", "Федорович", "Максимович", "Матвеевич", "Данилович", "Григорьевич", "Давидович")

    private val surnameList = listOf("Семенов", "Ильичов", "Андреев", "Федоров", "Максимов", "Матвеев", "Данилов", "Григорьев", "Давидов")
